...
#  Last Change: 09.11.2015 / Keneth Wagner2
#  ------------------------------------------------------------------
#
        ...
        while not bQuit:
            ...
            if choice == "Q":
                ...
                try:
                    ...
                    pMsg.Direction = PLinApi.TLINDirection(lFrameEntry.Direction)
                    pMsg.ChecksumType = PLinApi.TLINChecksumType(lFrameEntry.ChecksumType)
